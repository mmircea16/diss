...
int8_8 log8_8(int8_8 x)
{
	uint64_t a[16]={8332236554, 7406432492, 6665789243, 6059808403, 5554824369, 5127530187, 4761278030, 4443859495, 4166118277, 3921052496, 3703216246, 3508310128, 3332894621, 3174185353, 3029904201, 2898169236};
	int64_t lna[16]={2846223171, 2340348885, 1887828916, 1478474811, 1104763792, 760982981, 442691664, 146369537, -130821301, -391202069, -636695587, -868912534, -1089215556, -1298767715, -1498569661, -1689488527};
	if (x<=0) return 0;
	short k = norm8_8(x);
	uint16_t key = x;
	key >>= 12;
