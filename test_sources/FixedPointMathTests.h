...
char* test_div_8_8_v2()
{
	  ...
	  init_file("tests/gen/8_8/_divide.test");
	  int8_8 x1,x2,y;
...
char* test_saturated_div_8_8_v2()
{
	  mu_test_title("Divide for 8.8 - Newton Raphson");
	  init_file("tests/gen/8_8/saturated_divide.test");
	  int8_8 x1,x2,y;
	  Parsed_fixed_point input1;
	  Parsed_fixed_point input2;
	  Parsed_fixed_point output;
...
char* test_saturated_div_8_8()
{
	  mu_test_title("Saturated divide for 8.8 ");
	  init_file("tests/gen/8_8/saturated_divide.test");
	  int8_8 x1,x2,y;
	  Parsed_fixed_point input1;
	  Parsed_fixed_point input2;
...
char* test_saturated_div_16_16()
{
	  mu_test_title("Divide for 16.16");
	  init_file("tests/gen/16_16/saturated_divide.test");
	  int16_16 x1,x2,y;
	  Parsed_fixed_point input1;
	  Parsed_fixed_point input2;
	  Parsed_fixed_point output;
...
char* test_saturated_div_16_16_v2()
{
	  mu_test_title("Divide for 16.16 - Newton Raphson");
	  init_file("tests/gen/16_16/saturated_divide.test");
	  int16_16 x1,x2,y;
...
char* test_saturated_div_8_24()
{
	  mu_test_title("Divide for 8.24");
	  init_file("tests/gen/8_24/saturated_divide.test");
	  int8_24 x1,x2,y;
	  Parsed_fixed_point input1;
	  Parsed_fixed_point input2;
	  Parsed_fixed_point output;
...
char* test_saturated_div_8_24_v2()
{
	  mu_test_title("Saturated divide for 8.24 - NewtonRaphson");
	  init_file("tests/gen/8_24/saturated_divide.test");
	  int8_24 x1,x2,y;
	  Parsed_fixed_point input1;
	  Parsed_fixed_point input2;
...
char* test_sine_8_8()
{
	  mu_test_title("Sine for 8.8");
	  init_file("tests/gen/8_8/sine.test");
	  int8_8 x1,y;
	  Parsed_fixed_point input1;
	  Parsed_fixed_point output;
	  int i=0;
...
char* test_exp_8_24()
{
	  mu_test_title("Exp for 8.24");
	  init_file("tests/gen/8_24/exp.test");
	  int8_24 x1,y;
	  Parsed_fixed_point input1;
	  Parsed_fixed_point output;
	  int i=0;
...
char* test_saturated_div_24_8()
{
	  mu_test_title("Saturated divide for 24.8");
	  init_file("tests/gen/24_8/saturated_divide.test");
	  int24_8 x1,x2,y;
	  Parsed_fixed_point input1;
	  Parsed_fixed_point input2;
	  Parsed_fixed_point output;
...
char* test_saturated_div_24_8_v2()
{
	  mu_test_title("Saturated divide for 24.8 - Newton Rapshon");
	  init_file("tests/gen/24_8/saturated_divide.test");
	  int24_8 x1,x2,y;
	  Parsed_fixed_point input1;
	  Parsed_fixed_point input2;
...
//	mu_run_test(test_saturated_div_8_8);
//	mu_run_test(test_saturated_div_8_8_v2);
//	mu_run_test(test_saturated_div_16_16);
//	mu_run_test(test_saturated_div_16_16_v2);
//	mu_run_test(test_saturated_div_8_24);
//    mu_run_test(test_saturated_div_8_24_v2);
//	mu_run_test(test_saturated_div_24_8);
//    mu_run_test(test_saturated_div_24_8_v2);
//
//	mu_run_test(test_sine_8_8);
