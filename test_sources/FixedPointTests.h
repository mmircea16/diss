...
char* test_floor()
{
	...
	while (get_operand(i,1)!=NULL)
	{
	  ...
	  x = set_int_part_8_8(x1,input1.integer_part);
	  x = set_fract_part_8_8(x1,input1.fractional_part);
...
char* test_integer_part_8_24()
{
	mu_test_title("Integer part 8.24");
	init_file("tests/gen/8_24/integer_part.test");
	int8_24 x,y;
	x=*(int8_24*)malloc(sizeof(int8_24));
	y=*(int8_24*)malloc(sizeof(int8_24));
	Parsed_fixed_point input;
	Parsed_fixed_point output;
	int i=0;
	while (get_operand(i,1)!=NULL)
	{
	   ...
	   x = set_int_part_8_24(x,input.integer_part);
	   x = set_fract_part_8_24(x,input.fractional_part);
	   y = floor8_24(x);
	   mu_assert_line("error",i,((get_int_part_8_24(y)==output.integer_part)&&(get_fract_part_8_24(y)==output.fractional_part)));
	   i++;
	}
...
char* test_fractional_part_8_24()
{
	mu_test_title("Fractional part 8.24");
	init_file("tests/gen/8_24/fractional.test");
	int8_24 x,y;
	x=*(int8_24*)malloc(sizeof(int8_24));
	y=*(int8_24*)malloc(sizeof(int8_24));
	Parsed_fixed_point input;
...
char* test_subtract_24_8()
{
  mu_test_title("Subtracting 24.8");
  init_file("tests/gen/24_8/subtract.test");
  int24_8 x1,x2,y;
...
char* test_saturated_subtract_24_8()
{
  mu_test_title("Saturated subtracting 24.8");
  init_file("tests/gen/24_8/saturated_subtract.test");
  int24_8 x1,x2,y;
  Parsed_fixed_point input1;
  Parsed_fixed_point input2;
  Parsed_fixed_point output;
...
char* test_multiplying_24_8()
{
  mu_test_title("Multiplying 24.8");
  init_file("tests/gen/24_8/multiply.test");
  int24_8 x1,x2,y;
  Parsed_fixed_point input1;
  Parsed_fixed_point input2;
  Parsed_fixed_point output;
...
char* test_saturated_multiplying_24_8()
{
  mu_test_title("Saturated multiplying 24.8");
  init_file("tests/gen/24_8/saturated_multiply.test");
  int24_8 x1,x2,y;
  Parsed_fixed_point input1;
  Parsed_fixed_point input2;
  Parsed_fixed_point output;
...
char* test_integer_part_24_8()
{
	...
	while (get_operand(i,1)!=NULL)
	{
	   ...
	   (output.fractional_part) >>=24;
	   (input.fractional_part) >>=24;
	   x = set_int_part_24_8(x,input.integer_part);
	   x = set_fract_part_24_8(x,input.fractional_part);
